...
Comments: From the plot, items ordered from resh vegetable and fresh
fruit are the most.
...
over time. For some states, the fluctuation in data value is really big.
Since the plot contains too many data, it is hard to intepret it
detailly.
...
levels, males tend to have less daily total activity than females. For
example, in the more than high school group, the average total activity
for male is 1.2041457^{4} minutes. For female, the number is
1.3812863^{4} minutes. Additionally, in all three groups, higher age
people tend to have lower total activities.
...
has similar activity trend in the day. People are most active in the
morning and afternoon. From the trend line, females are more active than
males when they have education at “high school equivalent” or “more than
high school”.
