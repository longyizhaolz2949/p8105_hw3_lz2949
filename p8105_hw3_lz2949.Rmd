...
Construct a dataset that is limited to Excellent responses and contains, year, state, and a variable averages the data_value across locations within a state. Make a spaghetti plot. 
```{r}
...
```
Comments: drop the legend, general trend 
